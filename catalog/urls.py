...
from catalog.views import IndexView, ContactsView, ProductView, ProductCreateView, ProductDetailView, \
...
urlpatterns = [
    ...
    path('view/<int:pk>/', cache_page(30)(ProductDetailView.as_view()), name='product-view'),
